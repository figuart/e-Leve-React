    ...
    <div className="container-fluid">
        <section className="container text-center">
           ...
           <Form className="form-group col-12 justify-content-center" action="mailto:e-leve.tecnologia@yandex.com">
                <Nome type="text" className="container-fluid col-12 col-sm-6" name="nome" placeholder="Nome Completo" id="name"/>
                <Nome type="text" className="col-12 col-md-8 col-sm-6" name="nome" placeholder="Nome Completo" id="name"/> 
